...
public class OperacoesReservaV2 {
...
/*		private NO_Reserva inicio;
		...
		public void RealizarReserva() {
			...
			int cpf =Integer.parseInt(JOptionPane.showInputDialog("Informe o CPF ou RNE do cliente: "));
			String retorno= buscarClientes.BuscarClientes(cpf);
			if (retorno!=null){
			//retorno = cliente.getNome();
			reserva.setCliente(retorno);}
